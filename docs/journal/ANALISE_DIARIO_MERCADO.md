...
10. **Templates/prompts de entrada** (gratidão, reflexão do dia, revisão semanal) — inspirado nos "coach programs" do Journey; reduz a fricção da página em branco.
...
12. **Bloqueio adicional (PIN/biometria) para a seção de diário** — camada de privacidade extra, específica desse módulo por lidar com conteúdo mais sensível que uma nota comum.
