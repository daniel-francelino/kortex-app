      ...
      <div class="footer-grid">
        <div class="footer-brand">
          ...
          <p class="brand-heading">
            Sua vida tem contexto.<br />Seu sistema também.
          </p>
          <p class="brand-description">
            Reúna ideias, prioridades e rotina em um só lugar. Mais clareza para
            decidir o próximo passo.
          </p>
          <p class="product-scope">
            Notas <span aria-hidden="true">/</span> Tarefas
            <span aria-hidden="true">/</span> Hábitos
            <span aria-hidden="true">/</span> Diário
          </p>
          <div class="brand-actions">
            ...
            <NuxtLink
              ...
              @click="trackLink('Entrar', '/login')"
              >Já tenho conta</NuxtLink
            >
          </div>
        </div>
        <nav
        ...
        >
          ...
          <p v-if="column.label === 'Sua conta'" class="account-note">
            Acesse com sua conta Kortex.
          </p>
        </nav>
      </div>
...
.app-footer {
  ...
  background: color-mix(in srgb, var(--ui-bg-elevated) 20%, var(--ui-bg));
}
.app-footer::before {
  content: "";
  position: absolute;
